...
<header <?php if ($admin) echo 'style=padding:0 important!'; ?>>
    ...
    <div class="menu" <?php if ($admin) echo 'style=background-color:darkgrey important!'; ?>>
        <ul>
            ...
            <li class=" menu - item hidden"><a href=" <?= base_url('news') ?>">News</a>
            </li>
			<?php if (!$admin) { ?>
                <li class="menu-item hidden"><a href="<?= base_url('admin') ?>">Admin</a>
                </li>
			<?php } ?>

			<?php if ($admin) { ?>
                <li class="menu-item hidden"><a href="<?= base_url('logout') ?>">Logout</a>
                </li>
			<?php } ?>
